...
public class Ex9 {
	 ...
	 * fornecida para cada gato é sempre a mesma. Crie um algoritmo que receba o
	...
	public static void main(String[] args) {
		...
		System.out.println("Em " + dias + " dias, vai sobrar: "
				+ ((qtdeRacao * 1000) - ((qtdeDiariaGatos * 2) * dias)) / 1000 + " Kg.");
